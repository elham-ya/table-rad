...
import { Row, Col, Input, Label, Badge, UncontrolledTooltip } from "reactstrap";
    ...
    const IconExcel = ({ isActive }: { isActive: boolean }) =>
      isActive ? (
        ...
        >
          ...
          />
          <path
            d="M10.5792 14.9731L12.8829 11.0718H14.7114L11.5582 16.2491L14.7978 21.4998H12.9404L10.5792 17.5398L8.21793 21.4998H6.375L9.61453 16.2491L6.44699 11.0718H8.27552L10.5792 14.9731Z"
            fill="#03B958"
          />
          <path d="M17.6629 21.5H16.1367V10.5H17.6629V21.5Z" fill="#03B958" />
          <path
            d="M22.2705 16.4399L23.8399 13.7559H25.5388L23.1488 17.5692L25.6252 21.4999H23.9262L22.2849 18.7132L20.6435 21.4999H18.9302L21.4066 17.5692L19.0166 13.7559H20.7155L22.2705 16.4399Z"
            fill="#03B958"
          />
        </svg>
      ) : (
      ...
      isActive ? (
        ...
        >
          ...
          <g clip-path="url(#clip0_58_41089)">
            <path
              opacity="0.4"
              d="M19.5799 15.9999C19.5799 17.9799 17.9799 19.5799 15.9999 19.5799C14.0199 19.5799 12.4199 17.9799 12.4199 15.9999C12.4199 14.0199 14.0199 12.4199 15.9999 12.4199C17.9799 12.4199 19.5799 14.0199 19.5799 15.9999Z"
              stroke="#6155F5"
              stroke-width="1.5"
            ...
            />
            <path
              d="M16.0001 24.2702C19.5301 24.2702 22.8201 22.1902 25.1101 18.5902C26.0101 17.1802 26.0101 14.8102 25.1101 13.4002C22.8201 9.80021 19.5301 7.72021 16.0001 7.72021C12.4701 7.72021 9.18009 9.80021 6.89009 13.4002C5.99009 14.8102 5.99009 17.1802 6.89009 18.5902C9.18009 22.1902 12.4701 24.2702 16.0001 24.2702Z"
              stroke="#6155F5"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        >
          ...
          >
            <div className={styles.first_field_wrapper}>
              ...
              <div className={styles.input_badge_wrapper}>
                ...
                <UncontrolledTooltip target="myBadge" placement="bottom">
                  نام اصلی
                </UncontrolledTooltip>
              </div>
            </div>
          ...
          <Col xs="2" className="d-flex align-items-center justify-content-end">
            <div className={styles.setting_icons}>
              <button
                id="myVisible"
                onClick={handleChangeFieldVisibility}
                title=""
              >
                <IconVisible isActive={inputValue.visible} />
                <UncontrolledTooltip target="myVisible" placement="bottom">
                  نمایش در جدول
                </UncontrolledTooltip>
              </button>
              <button id="myExcel" onClick={handleChangeExcelExport}>
                <IconExcel isActive={inputValue.excel} />
                <UncontrolledTooltip target="myExcel" placement="bottom">
                  دانلود فایل اکسل
                </UncontrolledTooltip>
              </button>
            </div>
